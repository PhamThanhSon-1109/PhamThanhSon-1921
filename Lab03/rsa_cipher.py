...
from ui.rsa import Ui_MainWindow # Đảm bảo file này đã được convert từ .ui mới nhất
import requests
...
class MyApp(QMainWindow):
    ...
    def call_api_encrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                data = response.json()
                # SỬA LỖI: dùng setPlainText cho QPlainTextEdit
    ...
    def call_api_sign(self):
        ...
        # Đảm bảo txt_info tồn tại trong ui_rsa.py
        payload = {
